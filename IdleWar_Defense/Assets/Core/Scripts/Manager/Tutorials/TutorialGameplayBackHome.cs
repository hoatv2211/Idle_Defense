...
{
    public class TutorialGameplayBackHome : TutorialController
    {
        //private JustButton btnHome;
        private JustButton btnLVUP;
        public TutorialGameplayBackHome(int pId, bool pIsToolTips) : base(pId, pIsToolTips)
        {
        }
	...
	*/
            ...
            //s = "Let's back home.I have something to show you";
            s = Localization.Get(Localization.ID.TUTORIAL_91);
